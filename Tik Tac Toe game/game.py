...
label = Label(text=player + " turn", font=('consolas',40), bg="violet")
label.pack(side="top")

reset_button = Button(text="restart", font=('consolas',20), bg="pink", command=new_game)
...
for row in range(3):
    for column in range(3):
        buttons[row][column] = Button(frame, text="",font=('consolas',40), bg="pink", width=5, height=2,
